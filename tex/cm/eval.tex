\chapter{CountMax的仿真模拟与系统测试}
%In this section, we first introduce the metrics and benchmarks for performance comparison. Then we implement CountMax, CountSketch and FSS, and run several sets of simulations on our software simulator.
...
除此之外，为了实现更加有意义的对比，我们还对CountSketch和FSS进行了改进。
